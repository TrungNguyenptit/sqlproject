...
<body>
    ...
    <div class="form-popup" id="loginform">
        <form action="LoginServlet" method="post" class="form-container">
            ...
            <input class="inf" name="username" type="text" placeholder="Tên đăng nhập" required /> <br>
            <input type="password" class="inf" name="password" type="text" placeholder="Mật khẩu" required /> <br>
